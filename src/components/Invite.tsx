  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {confirmLine} <span className='font-medium'>30 de mayo</span>
        </motion.p>
      </motion.div>
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        ...
        className='text-white font-primary text-md md:text-lg text-center px-4 mt-6 max-w-[500px] font-light'
      >
